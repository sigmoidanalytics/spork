...
public class POStream extends PhysicalOperator {
    ...
    public Object ocurrent_count;
    public Object oend_of_input;
    public BroadCastClient bClient=null;
    ...
    public POStream(OperatorKey k, ExecutableManager executableManager, 
        ...
        bClient = new BroadCastClient(System.getenv("BROADCAST_MASTER_IP"), Integer.parseInt(System.getenv("BROADCAST_PORT")));
    ...
    public Result getNextTuple() throws ExecException {
        ...
        try {
            ...
            /* try{
            	...
            	oend_of_input = bClient.getBroadCastMessage("end_of_input");
            	if(ocurrent_count !=null && oend_of_input !=null){            	
	            	long current_count = (long) ocurrent_count;
	                long end_of_input = (long) oend_of_input;
	                current_count = current_count + 1;
	                BroadCastServer bServer = Main.bcaster;
	                bServer.addResource("current_count", current_count);
	                if(current_count >= end_of_input){
	                	proceed = true;
	                }
            	}            	
                
            }catch(Exception e){
            	System.out.println("Crashhh in POStream :" + e);
            	e.printStackTrace();
            }*/
